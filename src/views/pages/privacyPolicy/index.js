                            ...
                            <Grid item xs={12} md={8} lg={8}>
                                <Grid container spacing={gridSpacing} sx={{ textAlign: 'left' }}>
                                    <Grid item xs={12}>
                                        ...
                                        <Typography variant="body1" sx={{ marginBottom: '1rem' }}>
                                            By accessing or using any part of the Services, you acknowledge that you have read this Policy
                                            and agree to be bound by its terms. If you do not agree to this Policy, do not use the Services.
                                        </Typography>
                                        ...
                                        <Box component="ol">
                                            <Typography variant="body1" sx={{ mb: '1rem' }}>
                                                ...
                                                <ul style={{ marginTop: '10px' }}>
                                                    ...
                                                    <li>
                                                        To communicate with you about the Services, including to send you updates and
                                                        marketing materials.
                                                    </li>
                                                    <li>
                                                        To monitor and analyze usage of the Services and to improve and personalize your
                                                        experience.
                                                    </li>
                                        ...
                                        <Box component="ol">
                                            <Typography variant="body1" sx={{ mb: '1rem' }}>
                                                ...
                                                for which it was collected, or as required by law. We may also retain and use your
                                                information to comply with our legal obligations, resolve disputes, and enforce our
                                                agreements.
                                            </Typography>
                                        </Box>
                                        <Typography variant="h2" sx={{ marginBottom: '1rem' }}>
                                        ...
                                        <Box component="ol">
                                            <Typography variant="body1" sx={{ mb: '1rem' }}>
                                                We may update this Policy from time to time by posting a revised version on our website.
                                                Your continued use of the Services after the effective date of any revised Policy
                                        ...
                                        <Box component="ol">
                                            <Typography variant="body1" sx={{ mb: '1rem' }}>
                                                ...
                                                contact us at <Link href="mailto:hello@galileoprotocol.io">hello @galileoprotocol.io</Link>
                                            </Typography>
                                        </Box>
                                        <Typography variant="body1" sx={{ marginBottom: '1rem' }}>
